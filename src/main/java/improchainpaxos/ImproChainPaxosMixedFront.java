...
public class ImproChainPaxosMixedFront extends FrontendProto {
    ...
    private static final Logger logger = LogManager.getLogger(ImproChainPaxosMixedFront.class);
    ...
    public ImproChainPaxosMixedFront(Properties props, short protoIndex, Application app) throws IOException {
    ...
    protected void onPeerBatchMessage(PeerBatchMessage msg, Host from, short sProto, int channel) {
        sendRequest(new SubmitBatchRequest(msg.getBatch()), ImproChainPaxosMixedProto.PROTOCOL_ID);
    }
