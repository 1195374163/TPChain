...
public class ImproChainPaxosMixedProto extends GenericProtocol {
    ...
    private static final Logger logger = LogManager.getLogger(ImproChainPaxosMixedProto.class);
    ...
    public ImproChainPaxosMixedProto(Properties props, EventLoopGroup workerGroup) throws UnknownHostException {
    ...
    private void executeMembershipOp(InstanceState instance) {
        ...
        if (o.opType == MembershipOp.OpType.REMOVE) {
            ...
            if (state == State.ACTIVE) {
                ...
                sendRequest(new GetSnapshotRequest(target, instance.iN), ImproChainPaxosMixedFront.PROTOCOL_ID_BASE);
            }
        }
    }
